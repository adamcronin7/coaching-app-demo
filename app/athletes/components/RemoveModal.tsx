...
const cancelButtonRef = useRef(null)
  ...
  return (
    ...
    <button onClick={() => setOpen(true)}
                  type="button"
                  className="flex text-xs bg-red-400 hover:bg-red-500 cursor-pointer text-center text-white py-2 px-4 rounded transition-color"
                >
                  Remove
                </button>
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                      <AiOutlineUserDelete className="h-6 w-6 text-red-400" aria-hidden="true" />
                    </div>
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to remove this user from your athletes? You will lose coaching access to their account.
                        </p>
                      </div>
                    </div>
                  </div>
